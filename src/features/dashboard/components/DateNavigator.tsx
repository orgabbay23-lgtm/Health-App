...
export function DateNavigator({
  ...
  return (
    <div className="specular flex flex-col gap-3 rounded-[28px] border border-white/70 bg-white/85 backdrop-blur-md p-4 shadow-premium sm:flex-row sm:items-center sm:justify-between">
